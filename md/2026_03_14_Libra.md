...
[[Libra]](https://eprint.iacr.org/2019/317.pdf) is a protocol integrating GKR sumcheck protocol for IOP and modified multilinear KZG (zkVPD in the paper).
...
$$
\begin{align*}\alpha_1V_1(u_1)+\beta_1V_1(v_1)&=\sum_{x,y\in\{0,1\}^{s_2}}\big[(\alpha_1\mathsf{add}_1(u_1,x,y)+\beta_1\mathsf{add}_1(v_1,x,y))(V_1(x)+V_1(y))+(\alpha_1\mathsf{mul}_1(u_1,x,y)+\beta_1\mathsf{mul}_1(v_1,x,y))V_1(x)V_1(y)\big]\\&:=\sum_{x,y}f_1(x,y).
\end{align*}
$$
...
$$
\begin{align*}
h_g(x)&=\sum_y f_1(g,x,y)f_3(y),\\
f(x,y)&=\sum_x f_2(x)h_g(x)
\end{align*}
$$

and we run two sumcheck protocols shown in $\mathsf{SumCheckProduct}$  below.

[![](/images/Libra/image.png)](/images/Libra/image.png)[![](/images/Libra/image1.png)](/images/Libra/image1.png)
...
[![](/images/Libra/image2.png)](/images/Libra/image2.png)[![](/images/Libra/image3.png)](/images/Libra/image3.png)

where

To sum all up,

[![](/images/Libra/image4.png)](/images/Libra/image4.png)
...
[1] Chiesa, A., Forbes, M.A., Spooner, N.: A Zero Knowledge Sumcheck and its Applications. CoRR abs/1704.02086 (2017), [http://arxiv.org/abs/1704.02086](http://arxiv.org/abs/1704.02086)
